---
name: naming
description: Choose clear, intent-revealing names for code concepts. Use when writing, reviewing, or refactoring variables, functions, methods, structs, interfaces, packages, files, request/response DTOs, enum values, and helper names.
---
